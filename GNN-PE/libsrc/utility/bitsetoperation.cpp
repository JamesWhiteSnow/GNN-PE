...
void BitsetOperation::intersectBitsetWithBitset(const uint64_t * __restrict__ a, const uint64_t * __restrict__ b,
                                                uint64_t * __restrict__ output, const uint32_t count) {
    for (uint32_t i = 0; i < count; ++i) {
        output[i] = a[i] & b[i];
    }
}

uint32_t BitsetOperation::intersectArrayWithBitset(const uint32_t *a, const uint32_t a_count, const uint64_t *b,
                                              uint32_t *output) {
    uint32_t count = 0;
...
uint32_t BitsetOperation::intersectArrayWithArray(const uint32_t *a, uint32_t a_count, const uint32_t *b,
                                                  uint32_t b_count, uint32_t *output) {
    uint32_t count;
...
uint32_t BitsetOperation::mergeIntersection(const uint32_t *a, uint32_t a_count, const uint32_t *b, uint32_t b_count,
                                            uint32_t *output) {
...
uint32_t BitsetOperation::skewIntersection(const uint32_t *small, uint32_t small_count, const uint32_t *large,
                                           uint32_t large_count, uint32_t *output) {
    uint32_t count = 0;
    if (0 == small_count) {
        return count;
    }
...
bool BitsetOperation::binarySearch(const uint32_t *src, uint32_t begin, uint32_t end, uint32_t target) {
