...
void GraphOperations::getKCore(const Static_Graph* graph, int* core_table) {
...
void GraphOperations::bfsTraversal(const Static_Graph* graph, VertexID root_vertex, TreeNode*& tree, VertexID*& bfs_order) {
